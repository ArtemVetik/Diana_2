public static class ConstantKeys
{
    ...
    public enum Backgrounds
    {
        ...
        OP_attic,
        OP_Diana_bedroom_night_wide,
        OP_Diana_bedroom_morning_wide,
        OP_basket,
        ...
        OP_suburb_night,
        OP_porch_letter_day,
        OP_Dianas_livingroom_day,
        OP_Dianas_livingroom_night,
        OP_Diana_kitchen_day_wide,
        OP_Diana_kitchen_night_wide,
        OP_night_street_emergemcy,
        OP_hospital_outside_day,
        OP_hospital_outside_night,
        OP_hospital_recept_inside_day,
        OP_hospital_recept_inside_night,
        OP_hospital_room_day,
        OP_hospital_room_night,
        OP_DV_backyard_day,
        OP_DV_backyard_night,
        OP_DV_kitchen_day,
        OP_DV_kitchen_night,
